...
import { Container, Card, Image, Row, Col, Badge, Button } from "react-bootstrap";
import NavBar from "../components/NavBar";
import SideBar from "../components/SideBar";
import { ChevronLeft, CircleUserRoundIcon } from "lucide-react";
...
const EmployeeDetail = () => {
  ...
  useEffect(() => {
    // TODO: Fetch employee detail from backend
    ...
    return (
      <div className="d-flex">
        ...
        <div className="flex-grow-1">
          <NavBar />
          <Container className="my-4">Loading employee details...</Container>
        </div>
      </div>
    );
  }
      ...
      <div className="flex-grow-1">
        ...
        <Container className="p-4">
          <div className="mb-4 fw-bold fs-2 d-flex align-items-center gap-2">
            <Button className="p-0" onClick={() => window.history.back()} variant="link text-dark"><ChevronLeft size={45} /></Button> View Employee Details
          </div>
